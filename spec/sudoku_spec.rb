...
describe "Format Games" do
 let(:all_games) {"1-58-2----9--764-52--4--819-19--73-6762-83-9-----61-5---76---3-43--2-5-16--3-89--
...
---------------------------------------------------------------------------------"}
 ...
 it ' Converts a string of games in to individual game strings' do
  expect(split_games(all_games).length).to eq 15
end

it ' Converts a game string into nested array' do
  expect(convert_to_nested_array(split_games(all_games)[0]).length).to eq 9
end
